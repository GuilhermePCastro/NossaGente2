...
function sendEmail() {
    ...
    let corpo = `Nome Completo: ${nome};%0D%0A%0D CPFCNPJ: ${CPF};%0D%0A%0D Dt. Nascimento: ${nascimento};%0D%0A%0D Celular: ${celular};%0D%0A%0D E-mail: ${email};%0D%0A%0D%0D%0A%0D Autorizo o cadastro dos meus dados para que um consultor da Nossagente entre em contato comigo.`
